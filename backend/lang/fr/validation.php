...
return [
    ...
    | versions, comme les règles de taille. N'hésitez pas à modifier ces
    | messages pour les adapter à votre application.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Le champ :attribute a été compromis. Veuillez choisir un autre mot de passe.',
    ],
